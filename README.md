...
Thes drivers can also be used with legacy folder structure (projects released via Firmware Catalog) by defining **LEGACY_DIR_STRUCTURE** macro in the SoftConsole project settings.
